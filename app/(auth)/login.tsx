[25.04.2026 16:08] Farhod: import React, { useState, useRef, useEffect } from 'react';
import {
        ...
        <View style={s.langRow}>
          {(['uz', 'ru', 'en'] as const).map(l => (
            <TouchableOpacity
              key={l}
              style={[s.
[25.04.2026 16:08] Farhod: langBtn, lang === l && s.langOn]}
            ...
            <View style={s.card}>
              ...
              <View style={s.otpFoot}>
                <TouchableOpacity onPress={() => { setStep('phone'); setOtp(['', '', '', '', '', '']); }}>
                  <Text style={s.
[25.04.2026 16:08] Farhod: linkTxt}>← Raqamni o'zgartirish</Text>
                </TouchableOpacity>
                {countdown > 0
...
[25.04.2026 16:08] Farhod: otpCell: { flex: 1, height: 50, borderRadius: R.md, backgroundColor: C.elevated, borderWidth: 1.5, borderColor: C.border, fontSize: 20, fontWeight: '800', color: C.t1 },
