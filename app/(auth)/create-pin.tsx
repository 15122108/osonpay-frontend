[25.04.2026 16:11] Farhod: import React, { useState, useEffect } from 'react';
import {
  ...
  return (
    <SafeAreaView style={ps.root}>
      <View style={ps.inner}>
        ...
        <NumPad
          onPress={handleNum}
[25.04.2026 16:11] Farhod: onDelete={() => {
            setError('');
    ...
    <SafeAreaView style={ps.root}>
      ...
      <View style={ps.inner}>
        ...
        <NumPad
          ...
          loading={loading}
        />
        <TouchableOpacity style={ps.forgotBtn} onPress={() => {
          Alert.alert(
            t('forgotPin'),
...
[25.04.2026 16:11] Farhod: title: { fontSize: 22, fontWeight: '800', color: C.t1, textAlign: 'center' },
