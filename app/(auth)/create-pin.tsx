    ...
    <SafeAreaView style={ps.root}>
      <View style={ps.inner}>
        ...
        <Text style={ps.
            ...
            export function PinLockScreen() {
              ...
              async function checkBiometric() {
                try {
                  ...
                  // Biometriya mavjud emas yoki xato
                }
              }
              ...
              async function tryBiometric() {
                try {
                  ...
                  // Foydalanuvchi bekor qildi yoki xato
                }
              }
              ...
              async function handleNum(n: string) {
                ...
                if (np.length === 4) {
                  ...
                  try {
                    ...
                    // Agar backend yangilangan user obyektini qaytarsa, uni ishlat:
                    ...
                    if (newAttempts >= 5) {
                      Alert.alert(
                        'Bloklandi',
                        "Ko'p noto'g'ri urinish. Qayta kirish kerak.",
            ...
            // Default eksport (agar siz CreatePinScreen ni asosiy ekran sifatida ishlatsangiz)
