...
try {
const [th, ts] = await Promise.all([api.getHistory(1, f), api.getStats()]);
...
<TouchableOpacity style={s.iconBtn} onPress={() => setShowStats(!showStats)}>
...
```
  {showStats && stats && (
    <View style={s.statsPanel}>
      {[
        ...
        { label: 'Jami', val: String(stats.total_count) + ' ta', color: C.primary },
      ].map((st, i) => (
  ...
  <ScrollView horizontal showsHorizontalScrollIndicator={false} contentContainerStyle={s.filterRow}>
    ...
    <TouchableOpacity style={s.filterChip}>
      <Text style={s.filterChipTxt}>Kartalar va xizmatlar</Text>
      <Text style={s.dropIcon}>▾</Text>
    </TouchableOpacity>
    <TouchableOpacity style={s.filterChip}>
      <Text style={s.filterChipTxt}>Kompaniyalar</Text>
      <Text style={s.dropIcon}>▾</Text>
    </TouchableOpacity>
    <TouchableOpacity style={s.filterChip}>
      <Text style={s.filterChipTxt}>Oluvchilar va yuboruvchilar</Text>
      <Text style={s.dropIcon}>▾</Text>
    </TouchableOpacity>
  </ScrollView>
  ...
  <TouchableOpacity style={s.promoBtn} activeOpacity={0.8}>
    <LinearGradient
      colors={C.gBrand}
      start={{ x: 0, y: 0 }}
      end={{ x: 1, y: 0 }}
...
iconBtn: {
width: 38, height: 38, borderRadius: 19, backgroundColor: C.elevated,
alignItems: ‘center’, justifyContent: ‘center’, borderWidth: 1, borderColor: C.border,
},
statsPanel: {
flexDirection: ‘row’, marginHorizontal: S.lg, marginBottom: S.sm,
backgroundColor: C.elevated, borderRadius: R.lg, padding: S.md,
...
marginHorizontal: S.lg, marginBottom: S.sm, backgroundColor: C.elevated,
borderRadius: R.lg, paddingHorizontal: S.md, height: 44,
borderWidth: 1, borderColor: C.border,
},
...
emptyTitle: {
fontSize: 17, fontWeight: ‘700’, color: C.t1,
...
promoBtn: { position: ‘absolute’, bottom: 90, left: S.lg, right: S.lg, borderRadius: R.lg, overflow: ‘hidden’ },
promoGrad: { paddingVertical: 16, alignItems: ‘center’ },
promoTxt: { color: ‘#FFF’, fontWeight: ‘700’, fontSize: 15 },
modalBg: { flex: 1, backgroundColor: ‘rgba(0,0,0,0.5)’, justifyContent: ‘flex-end’ },
modalBox: {
backgroundColor: C.surface, borderTopLeftRadius: R.xxl,
borderTopRightRadius: R.xxl, padding: S.xl, gap: 4,
},
modalTitle: { fontSize: 18, fontWeight: ‘800’, color: C.t1, marginBottom: S.md },
modalItem: {
flexDirection: ‘row’, justifyContent: ‘space-between’, alignItems: ‘center’,
paddingVertical: 14, paddingHorizontal: S.md, borderRadius: R.lg,
},
